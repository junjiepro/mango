...
export default function AgentLayout({
  ...
  // 引导相关
  const { shouldShow: shouldShowOnboarding, markAsCompleted, markAsSkipped } = useAgentOnboarding();
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="flex items-center justify-center h-96">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-muted-foreground">{t('loading', '加载中...')}</span>
          </div>
        </div>
      </div>
    );
        ...
        <div className="p-4 border-b border-border">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant={currentMode === 'advanced' ? 'default' : 'secondary'}>
            ...
            <CardContent className="p-3">
              <div className="flex items-start space-x-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    GPT-4 • {t('status.plugins', '插件')} • {t('status.tools', '工具')}
                  </p>
                </div>
              </div>
            </CardContent>
...
export function QuickActions({ mode, onModeChange, className }: QuickActionsProps) {
  ...
  return (
    <div className={cn("flex items-center space-x-2", className)}>
      <span className="text-sm text-muted-foreground">{t('quickActions.mode', '模式')}:</span>
