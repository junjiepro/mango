      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">查看您的 AI 助手使用情况和活动统计</p>
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-sm font-medium text-muted-foreground">总对话数</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-sm font-medium text-muted-foreground">今日对话</h3>
                    <p className="text-2xl font-bold">{agentStats.todayConversations}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-sm font-medium text-muted-foreground">平均响应</h3>
                    <p className="text-2xl font-bold">{agentStats.averageResponseTime}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-sm font-medium text-muted-foreground">首选模型</h3>
                    <p className="text-2xl font-bold">{agentStats.favoriteModel}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
