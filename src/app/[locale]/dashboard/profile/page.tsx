...
export default function ProfilePage() {
  ...
  // Agent 偏好设置
  const { preferences, loading: prefsLoading, updatePreferences, error: prefsError } = useAgentPreferences(user)
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {(updateError || prefsUpdateError || prefsError) && (
            <Alert variant="destructive" className="mb-6">
              ...
              <AlertDescription>
                {updateError || prefsUpdateError || prefsError?.message || '操作失败，请稍后重试'}
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mb-6">管理您的账户信息和 AI Agent 偏好设置</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {user.email_confirmed_at && (
                    <div>
                      <Label className="text-sm font-medium text-muted-foreground">邮箱验证时间</Label>
                      <p className="mt-1 text-sm p-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => handlePreferenceUpdate('mode', value)}
                      >
                        <SelectTrigger>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {preferences.mode === 'simple' ? '专注于核心功能的简化界面' : '完整功能的专业界面'}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">自动保存对话记录到云端</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">在消息中显示时间信息</p>
                      </div>
                      <Switch
                        checked={preferences.conversation_settings.show_timestamps}
                        onCheckedChange={(checked) =>
                          handlePreferenceUpdate('conversation_settings', {
                            ...preferences.conversation_settings,
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">打字指示器</Label>
                        <p className="text-xs text-muted-foreground">显示 AI 正在输入的动画</p>
                      </div>
                      <Switch
                        checked={preferences.conversation_settings.show_typing_indicator}
                        onCheckedChange={(checked) =>
                          handlePreferenceUpdate('conversation_settings', {
                            ...preferences.conversation_settings,
                    ...
                    {/* 历史记录限制 */}
                    <div className="space-y-2">
                      <Label className="text-sm font-medium">历史记录限制</Label>
                      <div className="px-3">
                        <Slider
                          value={[preferences.conversation_settings.history_limit]}
                          onValueChange={(value) =>
                            handlePreferenceUpdate('conversation_settings', {
                              ...preferences.conversation_settings,
                      ...
                      <p className="text-xs text-muted-foreground">
                        保留最近 {preferences.conversation_settings.history_limit} 条消息
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">实时显示 AI 回答过程</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">允许 AI 使用外部工具</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">启用长期记忆</Label>
                        <p className="text-xs text-muted-foreground">AI 记住上下文信息</p>
                      </div>
                      <Switch
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        当前值: {preferences.ai_settings.temperature} (值越高越有创造性)
                      </p>
                    </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">默认折叠侧边栏</Label>
                        <p className="text-xs text-muted-foreground">启动时自动折叠侧边栏</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-muted-foreground">减少界面间距和内边距</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">显示代码预览</Label>
                        <p className="text-xs text-muted-foreground">在对话中显示代码高亮</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">启用动画效果</Label>
                        <p className="text-xs text-muted-foreground">界面切换和交互动画</p>
                      </div>
                      <Switch
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">收集分析数据</Label>
                        <p className="text-xs text-muted-foreground">帮助我们改善产品体验</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">允许分享对话</Label>
                        <p className="text-xs text-muted-foreground">启用对话分享链接功能</p>
                      </div>
                      <Switch
                        checked={preferences.privacy_settings.share_conversations}
                        onCheckedChange={(checked) =>
                          handlePreferenceUpdate('privacy_settings', {
                            ...preferences.privacy_settings,
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <Label className="text-sm font-medium">启用个性化推荐</Label>
                        <p className="text-xs text-muted-foreground">基于使用历史提供个性化建议</p>
                      </div>
                      <Switch
                        checked={preferences.privacy_settings.personalization_enabled}
                        onCheckedChange={(checked) =>
                          handlePreferenceUpdate('privacy_settings', {
                            ...preferences.privacy_settings,
