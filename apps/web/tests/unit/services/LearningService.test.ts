...
describe('LearningService', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('@/services/LearningService')
    learningService = module.learningService
  })
  ...
  describe('getActiveRecords', () => {
    ...
    it('应该在用户未认证时抛出错误', async () => {
      ...
      await expect(learningService.getActiveRecords()).rejects.toThrow(
  ...
  describe('deleteRecord', () => {
    ...
    it('应该在删除失败时抛出错误', async () => {
      ...
      await expect(
        learningService.deleteRecord('learning-123')
